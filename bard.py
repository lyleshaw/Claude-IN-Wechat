...
class Chatbot:
    ...
    def __init__(self, session_id):
        headers = {
            ...
            "Origin": "https://bard.devs.wtf",
            "Referer": "https://bard.devs.wtf/",
        }
    ...
    def __get_snlm0e(self):
        resp = self.session.get(url="https://bard.devs.wtf/", timeout=10)
        # Find "SNlM0e":"<ID>"
    ...
    def ask(self, message: str) -> dict:
        ...
        resp = self.session.post(
            "https://bard.devs.wtf/_/BardChatUi/data/assistant.lamda.BardFrontendService/StreamGenerate",
            params=params,
            data=data,
            timeout=120,
        )
...
if __name__ == "__main__":
    ...
    # print(
    #     """
    #     Bard - A command-line interface to Google's Bard (https://bard.devs.wtf/)
